<template>
	<view class="page">
		...
		<view class="content">
			<!-- 用户名称 -->
			<view class="userInfo">
				<u-avatar size="168" :src="userInfo.avatar"></u-avatar>
				<view class="name">
					<view class="userName">
				...
				<view @tap="navigator('/pages/login/userInfo?info=' + JSON.stringify(userInfo))">
			...
			<view class="footer" v-if="userInfo.type == 1">
				...
				<u-cell-group :border="false">
					...
					<u-cell  @tap="navigator('/pages_platform/relation/index')" title="联系信息" :border="false" :isLink="true">
						<view slot="icon">
