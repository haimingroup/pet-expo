<template>
	<view class="page">
		...
		<view class="qrcode">
			...
			<view>
				<uqrcode ref="uqrcode" canvas-id="qrcode" :value="info.card_num"
					:options="{ margin: 10, foregroundColor: qrColor }"></uqrcode>
			</view>
		...
		<view class="regdata">
			<text>已登记信息</text>
			<view :style="'display: flex; color:'+themeColors" @tap="navigator('/pages_index/ticketInfo/userInfo')">
				<text>查看详情</text>
				<u-icon name="arrow-right" :color="themeColors" size="32"></u-icon>
			</view>
		</view>
		<view class="regdata">
			<text>订单详情</text>
			<view :style="'display: flex; color:'+themeColors" @tap="navigator('/pages_index/pay/index')">
				<text>查看详情</text>
				<u-icon name="arrow-right" :color="themeColors" size="32"></u-icon>
			</view>
		</view>
		...
		<view class="myTeam">
			<view class="myTeamHeader">
				...
				<view v-if="info.team" @tap="navigator('/pages_index/mine/myTeam/index')"
